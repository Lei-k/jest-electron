...
var createWindow;
plugin_1.default.forEach(function (p) {
    if (p.createWindow) {
...
var WindowPool = /** @class */ (function () {
    ...
    Object.defineProperty(WindowPool.prototype, "windows", {
        get: function () {
            return this.pool.map(function (p) { return p.win; });
        },
        enumerable: false,
        configurable: true
    });
    WindowPool.prototype.init = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!(i < this.maxSize)) return [3 /*break*/, 4];
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        var winOpts = {
                            ...
                            show: _this.debugMode,
                            focusable: _this.debugMode,
                            webPreferences: {
                                webSecurity: false,
...
//# sourceMappingURL=window-pool.js.map