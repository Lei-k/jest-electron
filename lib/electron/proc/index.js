...
exports.electronProc = exports.Electron = void 0;
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        if (process.env.JEST_ELECTRON_STARTUP_ARGS) {
                            args.splice.apply(args, __spreadArrays([0, 0], process.env.JEST_ELECTRON_STARTUP_ARGS.split(/\s+/)));
                        }
                        ;
                        if (process.env.JEST_ELECTRON_HEADLESS) {
                            console.log('run in headless mode');
                        }
                        var proc = child_process_1.spawn(process.env.JEST_ELECTRON_HEADLESS ?
                            'xvfb-run electron-mocha'
                            :
                                config.read().electron || electron, args, {
                            stdio: ['ipc'],
